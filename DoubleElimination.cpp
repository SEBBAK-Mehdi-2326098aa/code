...
string tournoidoubleelimination() {
    ...
    while (joueurs.size() > 1) {
        ...
        for (size_t i = 0; i < joueurs.size(); i += 2) {
            ...
            size_t firstround = duel(joueurs[i], joueurs[i + 1]);
...
for ( size_t i = 0 ; i<8; i+=2){
    ...
    size_t looserround = duel(perdanttour[i], perdanttour[i+1]);
    ...
    size_t looserround2= duel(perdanttour[i+8], perdanttour[i+9]);
        ...
        int looserround3 = duel(perdanttour[i+14], perdanttour[i+15]);
        ...
        int looserround4 = duel(perdanttour[i+20], perdanttour[i+21]);
        ...
        int looserfinal = duel(perdanttour[24], perdanttour[25]);
    ...
    size_t grandefinale = duel(winnerside[0], perdanttour[26]);
    ...
    if (grandefinale==2){
    size_t dernieremanche= duel(winnerside[0] , perdanttour[26]);
